...
//> return-from-top
    if (currentFunction == FunctionType.NONE) {
      Conyoscript.error(stmt.keyword, "Cannot return from top-level code.");
    }
...
//> Classes return-in-initializer
      if (currentFunction == FunctionType.INITIALIZER) {
        Conyoscript.error(stmt.keyword,
...
//> invalid-super
    if (currentClass == ClassType.NONE) {
      Conyoscript.error(expr.keyword,
